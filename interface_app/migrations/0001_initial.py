# Generated by Django 2.1.5 on 2021-01-30 08:50
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('num', models.IntegerField(blank=True, verbose_name='接口序号')),
                ('name', models.CharField(blank=True, max_length=128, verbose_name='接口名称')),
                ('desc', models.CharField(blank=True, max_length=256, verbose_name='接口描述')),
                ('variable_type', models.CharField(blank=True, max_length=32, verbose_name='参数类型选择')),
                ('status_url', models.CharField(blank=True, max_length=32, verbose_name='基础url,序号对应项目的环境')),
                ...
                ('url', models.CharField(blank=True, max_length=256, verbose_name='接口地址')),
                ('skip', models.CharField(max_length=256, verbose_name='跳过判断')),
